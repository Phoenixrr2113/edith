...
import { TASKBOARD_FILE, TASKBOARD_ARCHIVE_DIR } from "./config";
...
export function archiveTaskboardEntries(expiredSections: string[], archiveDir: string = TASKBOARD_ARCHIVE_DIR): void {
...
export function getTaskboardArchive(month?: string): string {
  ...
  try { return readFileSync(archiveFile, "utf-8"); } catch { return ""; }
}
