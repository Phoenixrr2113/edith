...
let checkLocationRemindersResult: { reminder: { id: string; text: string }; locationLabel: string }[] = [];
let checkTimeRemindersResult: { id: string; text: string }[] = [];
let checkLocationTransitionsResult: { type: "arrived" | "departed"; locationName: string; locationLabel: string }[] = [];
